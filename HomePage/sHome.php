    ...
    <nav>
      <div class="abc" id="nav">
        <ul>
          ...
          <li class="links"><a href="./profileView.php?spview=<?php echo $_SESSION['user']?>">Account</a></li>
        ...
        <div class="card">
          ...
          ?>
            <div class="item">
                ...
                <span></span>
                <span></span>
                <a href="./quiz.php?quiz=<?php echo $record['id']?>" class="link">
                    <div class="bg"></div>
                    <div class="title">
                    ...
                    <div class="secret" style="display:none;"><?php echo $record['id']; ?></div>
                    <div class="bg1"></div>
                </a>
            </div>
          <?php }}}}?>
